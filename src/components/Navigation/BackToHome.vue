<template>
  <div class="pad-1em-0 flex" id="headerFixScroll">
    <div class="flex-1">
      <button class="btn-basic back-home" @click="backToHome">
        <!-- thêm class back-home và đổi canvas -->
    ...
    <div class="flex-2 text-center" @click="backToHome">logo</div>
